...
namespace BJVSExtension.Utilities
{
    internal static class ClassificationName
    {
        ...
        public static bool IsDeclaration(string classfication)
        {
            ...
            return classfication == "namespace name" || classfication == "property name" || classfication == "enum name" || classfication == "struct name" || classfication == "interface name" || classfication.Contains("class name");
        }

        public static bool IsMethod(string classfication)
        {
            //class name
            //class name - static symbol - (TRANSIENT) 静态构造函数
            //method name
            ...
            return classfication.Contains("method name");
        }
    }
}
